...
const SUBJECTS = {
  "sign-in": "Your BotFleet sign-in code",
  "email-verification": "Verify your BotFleet email",
  "forget-password": "Reset your BotFleet password",
  "change-email": "Confirm your BotFleet email change",
