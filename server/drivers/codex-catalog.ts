 ...
 * provide its live catalog.  The slugs matched this Mac's visible ChatGPT
 * OAuth model/list on 2026-09-24; the inexpensive Luna tier remains the
 * fallback default.  This snapshot is not proof of availability for another
 * account or a later CLI version.
 */
