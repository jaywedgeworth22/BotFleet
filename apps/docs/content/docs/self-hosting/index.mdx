---
title: Self-hosting BotFleet
description: Run the harness and desktop app on infrastructure you control.
icon: Server
---

BotFleet is local-first by default: the harness listens on loopback, agent CLIs run on your machine, and application state lives under `~/.botfleet`.

## Typical self-hosted setup

1. Run BotFleet on your personal macOS, Windows, or Ubuntu computer.
...
Self-hosting BotFleet does not self-host every optional provider:
