---
title: Changelog
description: Highlights from recent BotFleet desktop releases.
icon: Clock
---

The changelog tracks published desktop builds.  Changes merged into `main` after a release are not listed as shipped until a new build is published.  BotFleet builds live in the [BotFleet releases repository](https://github.com/jaywedgeworth22/botfleet-releases/releases); the entries below predate the fork and link to the upstream OpenMausBot release notes they came from.
...
- Existing OpenCode logins and anonymous free models now work without duplicate setup in BotFleet.

[Upstream OpenMausBot 0.1.32 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.32)
...
[Upstream OpenMausBot 0.1.29 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.29)
...
[Upstream OpenMausBot 0.1.27 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.27)
...
[Upstream OpenMausBot 0.1.25 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.25)
...
[Upstream OpenMausBot 0.1.24 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.24)
...
[Upstream OpenMausBot 0.1.23 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.23)
...
[Upstream OpenMausBot 0.1.22 release notes](https://github.com/milind-soni/openmausbot-releases/releases/tag/v0.1.22)

<Callout type="info" title="Every release remains available">
  Browse checksums, installers, and notes in the [BotFleet releases repository](https://github.com/jaywedgeworth22/botfleet-releases/releases).
</Callout>
