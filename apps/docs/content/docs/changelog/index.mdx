...
The changelog tracks published desktop builds.  Changes merged into `main` after a release are not listed as shipped until a new build is published.  BotFleet builds live in the [BotFleet Releases page](https://github.com/jaywedgeworth22/BotFleet/releases); the entries below predate the fork and link to the upstream OpenMausBot release notes they came from.
...
<Callout type="info" title="Every release remains available">
  Browse checksums, installers, and notes in the [BotFleet Releases page](https://github.com/jaywedgeworth22/BotFleet/releases).
</Callout>
