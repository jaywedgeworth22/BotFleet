...
<Callout type="warn" title="Use official artifacts">
  Do not install update files forwarded through chat or uploaded to an unrelated repository. Use the BotFleet releases repository and its checksums.
</Callout>
