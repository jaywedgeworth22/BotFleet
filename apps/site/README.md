...
- `logo-256.png` / `icon-1024.png` / `apple-touch-icon.png` / `favicon-64.png` — the code-visor app icon (light-background rounded tile).
- `icon-transparent-1024.png` — transparent code-visor robot mark.
- `hero-bots.png` — the fleet-at-a-console hero art.  `wide-banner.png` / `wide-banner-transparent.png` — the code-visor wordmark lockup, light or transparent.
