...
final class PairingTests: XCTestCase {
    ...
    func testRejectsAServiceThatDoesNotIdentifyAsBotFleet() async throws {
    ...
    private static let health = Data(#"{"app":"botfleet","pid":42,"static":true}"#.utf8)
