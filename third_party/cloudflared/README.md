...
BotFleet stages the official `cloudflared` 2026.8.2 executable as a separate
...
| BotFleet target | Release asset | Release asset SHA-256 | Extracted executable SHA-256 |
| --- | --- | --- | --- |
