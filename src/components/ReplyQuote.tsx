  ...
  const body = (
    <>
      ...
      <span className="min-w-0 flex-1">
        ...
        {/* the quote clips to one line, so the hover carries a much longer
            slice of what was actually said */}
        <span className="block truncate text-[11.5px] text-ink-secondary" title={replySnippet(message.text ?? "", 1200)}>
