 ...
 * with no DSN yet must show the switch on unless the newer status payload
 * carries an explicit opt-out.  Otherwise the first Save after pasting a
 * DSN would write `enabled: false` and turn diagnostics off. */
