...
The fake native ACP process covers exact spawn arguments, standard MCP transport, model and reasoning confirmation, resume without transcript replay, permission requests, semantic text/tool updates, cancellation, and error classification.  Focused DSH plus shared ACP tests passed 63/63 before current-main integration.
