...
Typecheck, three consent-policy tests, two renderer checks, and eight focused real API tests passed.  The actual warning component was rendered with three synthetic bot names and stable IDs and captured in `docs/screenshots/fleet-auto-consent.png`; no production permissions were changed.  Full validation and the Local VM concurrency fixture remain pending.
