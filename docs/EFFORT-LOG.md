...
## In Progress
- **2026-09-02 — AG — IN PROGRESS — Quota/cap telemetry parity, Gemini 3.8 Flash, Kimi/Gemini/DeepSeek-API driver cleanup, header protection & acoustic echo suppression (PR #144, branch `ag/dsh-antigravity-fallback-parity-terminology`).**
